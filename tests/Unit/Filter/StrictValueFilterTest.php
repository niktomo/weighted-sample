...
class StrictValueFilterTest extends TestCase
{
    ...
    public function test_accepts_positive_weight_and_positive_count(): void
    {
        ...
        // Act & Assert
        $this->assertTrue($filter->accepts('item', 10, 3), 'weight=10, count=3 のアイテムが受け入れられること');
    }
    ...
    public function test_throws_on_negative_weight(): void
    {
        ...
        // Act
        $filter->accepts('item', -1, null);
    }

    public function test_throws_on_zero_count(): void
    {
        // Arrange
        $filter = new StrictValueFilter();
        ...
        // Act
        $filter->accepts('item', 10, 0);
    }

    public function test_throws_on_negative_count(): void
    {
        // Arrange
        $filter = new StrictValueFilter();
